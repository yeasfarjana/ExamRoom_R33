    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    System.Net.Mail.MailMessage m = new System.Net.Mail.MailMessage(new System.Net.Mail.MailAddress("examroomr33@gmail.com", "ExamRoomR33"), new System.Net.Mail.MailAddress(user.Email));
                    ...
                    smtp.Credentials = new System.Net.NetworkCredential("examroomr33@gmail.com", "Asp.farjana");
                    smtp.EnableSsl = true;
                    smtp.Send(m);
